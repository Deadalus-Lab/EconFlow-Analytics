...
* Accepting responsibility, apologising to those affected by our mistakes, and learning from the
 experience
...
Technical disagreement is welcome and expected; this is a project about correctness, and correctness
arguments should be made forcefully. Pushing back on a proposal with specific technical reasoning is
not incivility — it is the work. What is not acceptable is directing that force at a person rather
than at an argument.
...
maintainers at:
 ...
 (https://github.com/Deadalus-Lab/EconFlow-Analytics/security/advisories/new)

Use that channel even for conduct reports rather than security ones: it is the only route this
project offers that is private, authenticated, and visible solely to the maintainers. Do not open a
...
1. **Correction** — a private, written warning, with clarity about the nature of the violation.
