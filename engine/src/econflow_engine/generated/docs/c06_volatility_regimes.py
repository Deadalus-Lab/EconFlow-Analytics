...
NODE_DOCS: dict[str, dict[str, Any]] = {
    'bekk_estimate': {
        'fn': 'bekk_estimate',
        'description': 'bekk_estimate -- category 06-volatility-regimes, method card #160.',
    ...
    'bekk_var': {
        'fn': 'bekk_var',
        'description': 'bekk_var -- category 06-volatility-regimes, method card #160.',
    ...
    'bekk_virf': {
        'fn': 'bekk_virf',
        'description': 'bekk_virf -- category 06-volatility-regimes, method card #160.',
    ...
    'dcc_fit': {
        'fn': 'dcc_fit',
        'description': 'dcc_fit -- category 06-volatility-regimes, method card #29.',
    ...
    'dcc_forecast': {
        'fn': 'dcc_forecast',
        'description': 'dcc_forecast -- category 06-volatility-regimes, method card #29.',
    ...
    'dcc_multispec': {
        'fn': 'dcc_multispec',
        'description': 'dcc_multispec -- category 06-volatility-regimes, method card #29.',
    ...
    'dcc_roll': {
        'fn': 'dcc_roll',
        'description': 'dcc_roll -- category 06-volatility-regimes, method card #29.',
    ...
    'dcc_sim': {
        'fn': 'dcc_sim',
        'description': 'dcc_sim -- category 06-volatility-regimes, method card #29.',
    ...
    'dcc_spec': {
        'fn': 'dcc_spec',
        'description': 'dcc_spec -- category 06-volatility-regimes, method card #29.',
    ...
    'fsv_cov': {
        'fn': 'fsv_cov',
        'description': 'fsv_cov -- category 06-volatility-regimes, method card #163.',
        'args': {'object': "Handle to an 'fsvdraws' (from fsv_sample)."},
        'input_example': {'object': '<raw_handle>'},
    },
    'fsv_predict': {
        'fn': 'fsv_predict',
        'description': 'fsv_predict -- category 06-volatility-regimes, method card #163.',
    ...
    'fsv_sample': {
        'fn': 'fsv_sample',
        'description': 'fsv_sample -- category 06-volatility-regimes, method card #163.',
    ...
    'ga_diagnostics': {
        'fn': 'ga_diagnostics',
        'description': 'ga_diagnostics -- category 06-volatility-regimes, method card #28.',
    ...
    'ga_fit': {
        'fn': 'ga_fit',
        'description': 'ga_fit -- category 06-volatility-regimes, method card #28.',
    ...
    'ga_forecast': {
        'fn': 'ga_forecast',
        'description': 'ga_forecast -- category 06-volatility-regimes, method card #28.',
    ...
    'ga_roll': {
        'fn': 'ga_roll',
        'description': 'ga_roll -- category 06-volatility-regimes, method card #28.',
    ...
    'ga_sim': {
        'fn': 'ga_sim',
        'description': 'ga_sim -- category 06-volatility-regimes, method card #28.',
    ...
    'ga_spec': {
        'fn': 'ga_spec',
        'description': 'ga_spec -- category 06-volatility-regimes, method card #28.',
    ...
    'gas_fit': {
        'fn': 'gas_fit',
        'description': 'gas_fit -- category 06-volatility-regimes, method card #158.',
    ...
    'gas_forecast': {
        'fn': 'gas_forecast',
        'description': 'gas_forecast -- category 06-volatility-regimes, method card #158.',
    ...
    'gas_simulate': {
        'fn': 'gas_simulate',
        'description': 'gas_simulate -- category 06-volatility-regimes, method card #158.',
    ...
    'har_estimate': {
        'fn': 'har_estimate',
        'description': 'har_estimate -- category 06-volatility-regimes, method card #157.',
    ...
    'har_forecast': {
        'fn': 'har_forecast',
        'description': 'har_forecast -- category 06-volatility-regimes, method card #157.',
    ...
    'har_simulate': {
        'fn': 'har_simulate',
        'description': 'har_simulate -- category 06-volatility-regimes, method card #157.',
    ...
    'hf_realized_cov': {
        'fn': 'hf_realized_cov',
        'description': 'hf_realized_cov -- category 06-volatility-regimes, method card #156.',
    ...
    'hf_realized_var': {
        'fn': 'hf_realized_var',
        'description': 'hf_realized_var -- category 06-volatility-regimes, method card #156.',
    ...
    'hmm_predict': {
        'fn': 'hmm_predict',
        'description': 'hmm_predict -- category 06-volatility-regimes, method card #161.',
    ...
    'lstar_fit': {
        'fn': 'lstar_fit',
        'description': 'lstar_fit -- category 06-volatility-regimes, method card #32.',
    ...
    'mc_analytics': {
        'fn': 'mc_analytics',
        'description': 'mc_analytics -- category 06-volatility-regimes, method card #164.',
        'args': {'object': "Handle to a 'markovchain' object (from mc_fit)."},
        'input_example': {'object': '<raw_handle>'},
    },
    'mc_fit': {
        'fn': 'mc_fit',
        'description': 'mc_fit -- category 06-volatility-regimes, method card #164.',
    ...
    'mfg_fit': {
        'fn': 'mfg_fit',
        'description': 'mfg_fit -- category 06-volatility-regimes, method card #159.',
    ...
    'mfg_predict': {
        'fn': 'mfg_predict',
        'description': 'mfg_predict -- category 06-volatility-regimes, method card #159.',
    ...
    'mfg_simulate': {
        'fn': 'mfg_simulate',
        'description': 'mfg_simulate -- category 06-volatility-regimes, method card #159.',
    ...
    'msg_fit_mcmc': {
        'fn': 'msg_fit_mcmc',
        'description': 'msg_fit_mcmc -- category 06-volatility-regimes, method card #31.',
    ...
    'msg_fit_ml': {
        'fn': 'msg_fit_ml',
        'description': 'msg_fit_ml -- category 06-volatility-regimes, method card #31.',
        'args': {'spec': "Handle to an 'MSGARCH_SPEC' (from msg_spec).", 'data': 'Handle to a univariate numeric series (returns, without NA).'},
        'input_example': {'spec': '<raw_handle>', 'data': '<series_handle>'},
    },
    'msg_predict': {
        'fn': 'msg_predict',
        'description': 'msg_predict -- category 06-volatility-regimes, method card #31.',
    ...
    'msg_risk': {
        'fn': 'msg_risk',
        'description': 'msg_risk -- category 06-volatility-regimes, method card #31.',
    ...
    'msg_sim': {
        'fn': 'msg_sim',
        'description': 'msg_sim -- category 06-volatility-regimes, method card #31.',
    ...
    'msg_spec': {
        'fn': 'msg_spec',
        'description': 'msg_spec -- category 06-volatility-regimes, method card #31.',
    ...
    'msg_state': {
        'fn': 'msg_state',
        'description': 'msg_state -- category 06-volatility-regimes, method card #31.',
        'args': {'fit': "Handle to an 'MSGARCH_ML_FIT'/'MSGARCH_MCMC_FIT' (from msg_fit_*)."},
        'input_example': {'fit': '<raw_handle>'},
    },
    'ms_fit': {
        'fn': 'ms_fit',
        'description': 'ms_fit -- category 06-volatility-regimes, method card #30.',
    ...
    'ms_intervals': {
        'fn': 'ms_intervals',
        'description': 'ms_intervals -- category 06-volatility-regimes, method card #30.',
        'args': {'fit': "Handle to an 'MSM' model (from ms_fit).", 'level': 'Confidence level in (0,1) (default 0.95).'},
        'input_example': {'fit': '<raw_handle>', 'level': 0.95},
    },
    'ms_residuals': {
        'fn': 'ms_residuals',
        'description': 'ms_residuals -- category 06-volatility-regimes, method card #30.',
        'args': {'fit': "Handle to an 'MSM' model (from ms_fit).", 'regime': 'Regime 1..k for conditional residuals (default: all).'},
        'input_example': {'fit': '<raw_handle>'},
    },
    'setar_fit': {
        'fn': 'setar_fit',
        'description': 'setar_fit -- category 06-volatility-regimes, method card #32.',
    ...
    'setar_select': {
        'fn': 'setar_select',
        'description': 'setar_select -- category 06-volatility-regimes, method card #32.',
    ...
    'setar_test': {
        'fn': 'setar_test',
        'description': 'setar_test -- category 06-volatility-regimes, method card #32.',
    ...
    'star_fit': {
        'fn': 'star_fit',
        'description': 'star_fit -- category 06-volatility-regimes, method card #32.',
    ...
    'sv_predict': {
        'fn': 'sv_predict',
        'description': 'sv_predict -- category 06-volatility-regimes, method card #162.',
    ...
    'sv_sample': {
        'fn': 'sv_sample',
        'description': 'sv_sample -- category 06-volatility-regimes, method card #162.',
    ...
    'sv_simulate': {
        'fn': 'sv_simulate',
        'description': 'sv_simulate -- category 06-volatility-regimes, method card #162.',
    ...
    'tg_backtest': {
        'fn': 'tg_backtest',
        'description': 'tg_backtest -- category 06-volatility-regimes, method card #154.',
    ...
    'tg_estimate': {
        'fn': 'tg_estimate',
        'description': 'tg_estimate -- category 06-volatility-regimes, method card #154.',
    ...
    'tg_predict': {
        'fn': 'tg_predict',
        'description': 'tg_predict -- category 06-volatility-regimes, method card #154.',
    ...
    'thr_predict': {
        'fn': 'thr_predict',
        'description': 'thr_predict -- category 06-volatility-regimes, method card #32.',
    ...
    'thr_regime': {
        'fn': 'thr_regime',
        'description': 'thr_regime -- category 06-volatility-regimes, method card #32.',
        'args': {'object': "Handle to a 'setar'/'lstar' model (from setar_fit/lstar_fit)."},
        'input_example': {'object': '<raw_handle>'},
    },
    'tm_cov': {
        'fn': 'tm_cov',
        'description': 'tm_cov -- category 06-volatility-regimes, method card #155.',
    ...
    'tm_dcc_estimate': {
        'fn': 'tm_dcc_estimate',
        'description': 'tm_dcc_estimate -- category 06-volatility-regimes, method card #155.',
    ...
    'tm_predict': {
        'fn': 'tm_predict',
        'description': 'tm_predict -- category 06-volatility-regimes, method card #155.',
    ...
    'vr_figarch': {
        'fn': 'vr_figarch',
        'description': 'vr_figarch -- category 06-volatility-regimes, method card #437.',
        'args': {'y': 'Return series.', 'model': 'Model family.', 'p': 'Autoregressive order.', 'q': 'Moving-average order.', 'truncation': 'Lag truncation of the fractional polynomial.', 'distribution': 'Innovation distribution.'},
        'input_example': {'y': '<series_handle>', 'model': 'figarch', 'p': 1, 'q': 1, 'truncation': 1000, 'distribution': 't'},
    },
    'vr_ewma': {
        'fn': 'vr_ewma',
        'description': 'vr_ewma -- category 06-volatility-regimes, method card #438.',
        'args': {'y': 'Return series.', 'lambda_': 'Decay factor.', 'initial': 'Initialisation of the recursion.'},
        'input_example': {'y': '<series_handle>', 'lambda_': 0.94, 'initial': 'sample_variance'},
    },
    'vr_realised_garch': {
        'fn': 'vr_realised_garch',
        'description': 'vr_realised_garch -- category 06-volatility-regimes, method card #439.',
        'args': {'y': 'Daily return series.', 'realised': 'Daily realised variance measure.', 'model': 'Model family.', 'leverage': 'Include a leverage function.', 'distribution': 'Innovation distribution.'},
        'input_example': {'y': '<series_handle>', 'realised': '<series_handle>', 'model': 'realised_garch', 'leverage': True, 'distribution': 't'},
    },
    'vr_jump_test': {
        'fn': 'vr_jump_test',
        'description': 'vr_jump_test -- category 06-volatility-regimes, method card #440.',
        'args': {'prices': 'Intraday price series.', 'test': 'Test family.', 'interval': 'Sampling interval in seconds.', 'deseasonalise': 'Remove intraday periodicity first.', 'alpha': 'Significance level.'},
        'input_example': {'prices': '<irregular_series_handle>', 'test': 'bns', 'interval': 300, 'deseasonalise': True, 'alpha': 0.05},
    },
    'vr_variance_breaks': {
        'fn': 'vr_variance_breaks',
        'description': 'vr_variance_breaks -- category 06-volatility-regimes, method card #441.',
        'args': {'y': 'Return series.', 'method': 'Detection method.', 'penalty': 'Penalty for the segmentation methods.', 'max_breaks': 'Maximum breaks considered.', 'alpha': 'Significance level.'},
        'input_example': {'y': '<series_handle>', 'method': 'icss', 'max_breaks': 10, 'alpha': 0.05},
    },
    'vr_tvtp_switching': {
        'fn': 'vr_tvtp_switching',
        'description': 'vr_tvtp_switching -- category 06-volatility-regimes, method card #442.',
        'args': {'y': 'Series.', 'drivers': 'Variables driving the transition probabilities.', 'k_regimes': 'Number of regimes.', 'switching_variance': 'Allow the variance to switch.', 'n_starts': 'Random restarts.', 'seed': 'Seed for the random number generator.'},
        'input_example': {'y': '<series_handle>', 'drivers': '<exog_handle>', 'k_regimes': 2, 'switching_variance': True, 'n_starts': 10},
    },
    'vr_stochastic_volatility': {
        'fn': 'vr_stochastic_volatility',
        'description': 'vr_stochastic_volatility -- category 06-volatility-regimes, method card #443.',
        'args': {'y': 'Return series.', 'model': 'Model family.', 'method': 'Estimation method.', 'draws': 'Posterior draws.', 'warmup': 'Warm-up draws discarded.', 'seed': 'Seed for the random number generator; required for reproducibility.'},
        'input_example': {'y': '<series_handle>', 'model': 'lognormal', 'method': 'mcmc', 'draws': 5000, 'warmup': 1000, 'seed': 1},
    },
}
