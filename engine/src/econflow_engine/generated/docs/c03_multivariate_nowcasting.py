...
NODE_DOCS: dict[str, dict[str, Any]] = {
    'bt_fevd': {
        'fn': 'bt_fevd',
        'description': 'bt_fevd -- category 03-multivariate-nowcasting, METHOD-SELECTION card #13.',
    ...
    'bt_irf': {
        'fn': 'bt_irf',
        'description': 'bt_irf -- category 03-multivariate-nowcasting, METHOD-SELECTION card #13.',
    ...
    'bt_predict': {
        'fn': 'bt_predict',
        'description': 'bt_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #13.',
    ...
    'bt_summary': {
        'fn': 'bt_summary',
        'description': 'bt_summary -- category 03-multivariate-nowcasting, METHOD-SELECTION card #13.',
    ...
    'bt_var': {
        'fn': 'bt_var',
        'description': 'bt_var -- category 03-multivariate-nowcasting, METHOD-SELECTION card #13.',
        'args': {'data': 'Handle to ts/mts data (>=2 columns, no NA).', 'p': 'VAR(p) lag order (default 2).', 'deterministic': 'Deterministic terms (default const).', 'iterations': 'MCMC iterations (default 10000).', 'burnin': 'Burn-in draws (default 5000, < iterations).', 'seed': 'Seed for reproducibility (optional).'},
        'input_example': {'data': '<multiseries_handle>', 'p': 2, 'iterations': 10000, 'burnin': 5000},
    },
    'bvar_companion': {
        'fn': 'bvar_companion',
        'description': 'bvar_companion -- category 03-multivariate-nowcasting, METHOD-SELECTION card #12.',
        'args': {'model': 'Handle to a bvar model (companion matrix + stability check).'},
        'input_example': {'model': '<raw_handle>'},
    },
    'bvar_estimate': {
        'fn': 'bvar_estimate',
        'description': 'bvar_estimate -- category 03-multivariate-nowcasting, METHOD-SELECTION card #12.',
    ...
    'bvar_fevd': {
        'fn': 'bvar_fevd',
        'description': 'bvar_fevd -- category 03-multivariate-nowcasting, METHOD-SELECTION card #12.',
    ...
    'bvar_irf': {
        'fn': 'bvar_irf',
        'description': 'bvar_irf -- category 03-multivariate-nowcasting, METHOD-SELECTION card #12.',
    ...
    'bvar_predict': {
        'fn': 'bvar_predict',
        'description': 'bvar_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #12.',
    ...
    'bvar_summary': {
        'fn': 'bvar_summary',
        'description': 'bvar_summary -- category 03-multivariate-nowcasting, METHOD-SELECTION card #12.',
        'args': {'model': 'Handle to a bvar model (posterior coef/vcov/logLik/acceptance).'},
        'input_example': {'model': '<raw_handle>'},
    },
    'bvh_predict': {
        'fn': 'bvh_predict',
        'description': 'bvh_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #147.',
    ...
    'bvh_var': {
        'fn': 'bvh_var',
        'description': 'bvh_var -- category 03-multivariate-nowcasting, METHOD-SELECTION card #147.',
    ...
    'bvh_vhar': {
        'fn': 'bvh_vhar',
        'description': 'bvh_vhar -- category 03-multivariate-nowcasting, METHOD-SELECTION card #147.',
    ...
    'bvs_estimate': {
        'fn': 'bvs_estimate',
        'description': 'bvs_estimate -- category 03-multivariate-nowcasting, METHOD-SELECTION card #143.',
        'args': {'data': 'Handle to a numeric matrix with >=2 columns (multivariate VAR)· no NA/Inf· nrow>lags+1.', 'lags': 'VAR order (positive integer· default 1).', 'prior': 'Global-local shrinkage prior on Phi (default HS = Horseshoe)· specify_prior_phi.', 'draws': 'Retained posterior draws (positive integer· TINY default 200).', 'burnin': 'Burn-in draws (non-negative integer· default 100).', 'thin': 'Thinning factor (positive integer <= draws· default 1).', 'sv_keep': 'Which log-variance draws to keep (default last).', 'seed': 'MANDATORY seed (set.seed before the MCMC· cache key· bvar is stochastic).', 'min_draws': 'Minimum retained draws for convergence (non-negative· default 100).', 'ess_min': 'Minimum effective sample size of Phi (positive· default 1).', 'allow_nonconvergence': 'True = return the posterior with converged=False instead of stop when the gate fires (mirror rstan/MARSS).'},
    ...
    'bvs_irf': {
        'fn': 'bvs_irf',
        'description': 'bvs_irf -- category 03-multivariate-nowcasting, METHOD-SELECTION card #143.',
    ...
    'bvs_predict': {
        'fn': 'bvs_predict',
        'description': 'bvs_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #143.',
    ...
    'df_dfm': {
        'fn': 'df_dfm',
        'description': 'df_dfm -- category 03-multivariate-nowcasting, METHOD-SELECTION card #15.',
    ...
    'df_icr': {
        'fn': 'df_icr',
        'description': 'df_icr -- category 03-multivariate-nowcasting, METHOD-SELECTION card #15.',
    ...
    'df_predict': {
        'fn': 'df_predict',
        'description': 'df_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #15.',
        'args': {'model': 'Handle to a dfm model (from df_dfm).', 'h': 'Forecast horizon for factors + variables (default 10).', 'standardized': 'Output in standardised units (default False = original units).'},
        'input_example': {'model': '<raw_handle>', 'h': 10, 'standardized': False},
    },
    'df_summary': {
        'fn': 'df_summary',
        'description': 'df_summary -- category 03-multivariate-nowcasting, METHOD-SELECTION card #15.',
        'args': {'model': 'Handle to a dfm model (loadings/R2/explained variance).'},
        'input_example': {'model': '<raw_handle>'},
    },
    'md_forecast': {
        'fn': 'md_forecast',
        'description': 'md_forecast -- category 03-multivariate-nowcasting, METHOD-SELECTION card #18.',
        'args': {'model': 'Handle to a midas_r model (from md_midas).', 'newx': 'Handle to future high-freq values (length = h*m).', 'm': 'Frequency ratio (same as the fit).'},
        'input_example': {'model': '<raw_handle>', 'newx': '<raw_handle>', 'm': 1},
    },
    'md_haht': {
        'fn': 'md_haht',
        'description': 'md_haht -- category 03-multivariate-nowcasting, METHOD-SELECTION card #18.',
        'args': {'model': 'Handle to a midas_r model (from md_midas).', 'robust': 'HAC-robust hAhr_test instead of hAh_test (default False).'},
        'input_example': {'model': '<raw_handle>', 'robust': False},
    },
    'md_midas': {
        'fn': 'md_midas',
        'description': 'md_midas -- category 03-multivariate-nowcasting, METHOD-SELECTION card #18.',
    ...
    'md_select': {
        'fn': 'md_select',
        'description': 'md_select -- category 03-multivariate-nowcasting, METHOD-SELECTION card #18.',
    ...
    'mf_estimate': {
        'fn': 'mf_estimate',
        'description': 'mf_estimate -- category 03-multivariate-nowcasting, METHOD-SELECTION card #17.',
    ...
    'mf_mdd': {
        'fn': 'mf_mdd',
        'description': 'mf_mdd -- category 03-multivariate-nowcasting, METHOD-SELECTION card #17.',
    ...
    'mf_predict': {
        'fn': 'mf_predict',
        'description': 'mf_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #17.',
    ...
    'mml_cv': {
        'fn': 'mml_cv',
        'description': 'mml_cv -- category 03-multivariate-nowcasting, METHOD-SELECTION card #145.',
    ...
    'mml_fit': {
        'fn': 'mml_fit',
        'description': 'mml_fit -- category 03-multivariate-nowcasting, METHOD-SELECTION card #145.',
    ...
    'mml_predict': {
        'fn': 'mml_predict',
        'description': 'mml_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #145.',
    ...
    'pn_cyclical_components': {
        ...
        'description': 'pn_cyclical_components -- category 03-multivariate-nowcasting, METHOD-SELECTION card #256.',
    ...
    'pn_pca_nonstationary': {
        ...
        'description': 'pn_pca_nonstationary -- category 03-multivariate-nowcasting, METHOD-SELECTION card #256.',
    ...
    'sdf_factors': {
        'fn': 'sdf_factors',
        'description': 'sdf_factors -- category 03-multivariate-nowcasting, METHOD-SELECTION card #144.',
        'args': {'model': 'Handle to a sparseDFM model (extracts factor paths + covariances).'},
        'input_example': {'model': '<raw_handle>'},
    },
    'sdf_fit': {
        'fn': 'sdf_fit',
        'description': 'sdf_fit -- category 03-multivariate-nowcasting, METHOD-SELECTION card #144.',
    ...
    'sdf_predict': {
        'fn': 'sdf_predict',
        'description': 'sdf_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #144.',
    ...
    'stv_estimate': {
        'fn': 'stv_estimate',
        'description': 'stv_estimate -- category 03-multivariate-nowcasting, METHOD-SELECTION card #146.',
        'args': {'y': 'Handle to a multivariate series (mts, T x k, k>=2, no NA/Inf, nrow>p+1).', 'p': 'VAR lag order (positive integer, default 1).', 'mod_type': 'Prior shrinkage: double gamma (default) / triple gamma / ridge.', 'const': 'Include a time-varying intercept (default True).', 'niter': 'MCMC iterations including burn-in (positive integer, default 200).', 'nburn': 'Burn-in draws (non-negative, <= niter-2, default 100).', 'nthin': 'Thinning: every nthin-th draw is kept (default 1).', 'seed': 'MANDATORY seed (integer) — MCMC· set.seed before sampling.', 'ess_min': 'Minimum acceptable min-ESS (convergence gate· production >=200).', 'min_draws': 'Minimum retained draws for the convergence assessment (default 20).', 'allow_nonconvergence': 'If True, return a non-converged result (converged=False) instead of stop.'},
    ...
    'stv_forecast': {
        'fn': 'stv_forecast',
        'description': 'stv_forecast -- category 03-multivariate-nowcasting, METHOD-SELECTION card #146.',
    ...
    'stv_tvp': {
        'fn': 'stv_tvp',
        'description': 'stv_tvp -- category 03-multivariate-nowcasting, METHOD-SELECTION card #146.',
    ...
    'sv_estimate': {
        'fn': 'sv_estimate',
        'description': 'sv_estimate -- category 03-multivariate-nowcasting, METHOD-SELECTION card #14.',
    ...
    'sv_irf': {
        'fn': 'sv_irf',
        'description': 'sv_irf -- category 03-multivariate-nowcasting, METHOD-SELECTION card #14.',
    ...
    'sv_parameter_draws': {
        ...
        'description': 'sv_parameter_draws -- category 03-multivariate-nowcasting, METHOD-SELECTION card #14.',
    ...
    'sv_predict_density': {
        ...
        'description': 'sv_predict_density -- category 03-multivariate-nowcasting, METHOD-SELECTION card #14.',
    ...
    'sv_predict_draws': {
        'fn': 'sv_predict_draws',
        'description': 'sv_predict_draws -- category 03-multivariate-nowcasting, METHOD-SELECTION card #14.',
    ...
    'vr_arch_test': {
        'fn': 'vr_arch_test',
        'description': 'vr_arch_test -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
    ...
    'vr_causality': {
        'fn': 'vr_causality',
        'description': 'vr_causality -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
        'args': {'model': 'Handle to a varest model (from vr_var).', 'cause': 'Name of the causing variable (a subset of the VAR variables).', 'boot': 'Bootstrap p-values (default False).', 'boot_runs': 'Number of bootstrap replications (default 100).'},
        'input_example': {'model': '<raw_handle>', 'cause': '...', 'boot': False, 'boot_runs': 100},
    },
    'vr_normality_test': {
        'fn': 'vr_normality_test',
        'description': 'vr_normality_test -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
    ...
    'vr_predict': {
        'fn': 'vr_predict',
        'description': 'vr_predict -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
        'args': {'model': 'Handle to a varest/vec2var model (from vr_var/vr_vec2var).', 'n_ahead': 'Forecast horizon (default 10).', 'ci': 'Fan chart confidence level in (0,1) (default 0.95).'},
        'input_example': {'model': '<raw_handle>', 'n_ahead': 10, 'ci': 0.95},
    },
    'vr_serial_test': {
        'fn': 'vr_serial_test',
        'description': 'vr_serial_test -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
    ...
    'vr_var': {
        'fn': 'vr_var',
        'description': 'vr_var -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
        'args': {'y': 'Handle to a multivariate series (mts, K>=2 columns, no NA).', 'p': 'VAR(p) lag order (default 1).', 'type': 'Deterministic part (default const).'},
        'input_example': {'y': '<multiseries_handle>', 'p': 1},
    },
    'vr_varselect': {
        'fn': 'vr_varselect',
        'description': 'vr_varselect -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
        'args': {'y': 'Handle to a multivariate series (mts, K>=2 columns).', 'lag_max': 'Maximum lag order to evaluate (default 10).', 'type': 'Deterministic part (default const).'},
        'input_example': {'y': '<multiseries_handle>', 'lag_max': 10},
    },
    'vr_vec2var': {
        'fn': 'vr_vec2var',
        'description': 'vr_vec2var -- category 03-multivariate-nowcasting, METHOD-SELECTION card #11.',
        'args': {'z': 'Handle to a ca.jo Johansen object (from urca).', 'r': 'Cointegration rank r (1..K) (default 1).'},
