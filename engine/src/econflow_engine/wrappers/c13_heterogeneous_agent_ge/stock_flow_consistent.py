...
"""Method wrapper ``stock_flow_consistent`` -- method card #203.
...
Category 13-heterogeneous-agent-ge; module ``stock_flow_consistent``.
...
def sfc_simulate(
    *,
    ...
    """Node ``sfc_simulate`` -- method card #203.
    ...
    raise NotImplementedError(
        "sfc_simulate: not implemented."
    )


def sfc_scenario_run(
    *,
    baseline: Any,
    ...
    """Node ``sfc_scenario_run`` -- method card #203.
    ...
    Args:
        baseline: [raw_handle, required] Handle to a baseline sfcr_tbl (sfc_simulate.object)· the
    ...
    """
    raise NotImplementedError(
        "sfc_scenario_run: not implemented."
    )


def sfc_balance_check(
    *,
    baseline: Any,
    ...
    """Node ``sfc_balance_check`` -- method card #203.
    ...
    """
    raise NotImplementedError(
        "sfc_balance_check: not implemented."
    )
