...
"""Method wrapper ``small_linear_dsge`` -- METHOD-SELECTION card #200.
...
Category 13-dsge-general-equilibrium; module ``small_linear_dsge``.
...
def dsge_solve(
    *,
    ...
    """Node ``dsge_solve`` -- METHOD-SELECTION card #200.
    ...
    raise NotImplementedError(
        "dsge_solve: not implemented. The method card is in ./README.md."
    )
...
def dsge_estimate(
    *,
    ...
    """Node ``dsge_estimate`` -- METHOD-SELECTION card #200.
    ...
    """
    raise NotImplementedError(
        "dsge_estimate: not implemented. The method card is in ./README.md."
    )
...
def dsge_irf(
    *,
    ...
    """Node ``dsge_irf`` -- METHOD-SELECTION card #200.
    ...
    """
    raise NotImplementedError(
        "dsge_irf: not implemented. The method card is in ./README.md."
    )
...
def dsge_forecast(
    *,
    ...
    """Node ``dsge_forecast`` -- METHOD-SELECTION card #200.
    ...
    """
    raise NotImplementedError(
        "dsge_forecast: not implemented. The method card is in ./README.md."
    )
...
def dsge_shock_decomposition(
    *,
    ...
    """Node ``dsge_shock_decomposition`` -- METHOD-SELECTION card #200.
    ...
    """
    raise NotImplementedError(
        "dsge_shock_decomposition: not implemented. The method card is in ./README.md."
    )
