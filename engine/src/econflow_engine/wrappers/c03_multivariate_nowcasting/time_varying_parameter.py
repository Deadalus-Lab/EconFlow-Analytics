...
"""Method wrapper ``time_varying_parameter`` -- METHOD-SELECTION card #146.

#146 Time-Varying-Parameter VAR with stochastic volatility + dynamic global-local shrinkage
    (triple/double gamma or ridge) — shrinkTVPVAR
...
def stv_estimate(
    *,
    ...
    """Node ``stv_estimate`` -- METHOD-SELECTION card #146.
    ...
    Args:
        y: [multiseries_handle, required] Handle to a multivariate series (mts, T x k, k>=2, no
            NA/Inf, nrow>p+1).
        ...
        seed: [integer, required] MANDATORY seed (integer) — MCMC· set.seed before sampling.
    ...
    raise NotImplementedError(
        "stv_estimate: not implemented. The method card is in ./README.md."
    )
...
def stv_forecast(
    *,
    ...
    """Node ``stv_forecast`` -- METHOD-SELECTION card #146.
    ...
    """
    raise NotImplementedError(
        "stv_forecast: not implemented. The method card is in ./README.md."
    )
...
def stv_tvp(
    *,
    ...
    """Node ``stv_tvp`` -- METHOD-SELECTION card #146.
    ...
    """
    raise NotImplementedError(
        "stv_tvp: not implemented. The method card is in ./README.md."
    )
