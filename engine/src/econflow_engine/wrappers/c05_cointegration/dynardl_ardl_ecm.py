...
"""Method wrapper ``dynardl_ardl_ecm`` -- METHOD-SELECTION card #26.

#26 dynardl ARDL/ECM + stochastic simulation + PSS bounds + residual diagnostics

Category 05-cointegration; module ``dynardl_ardl_ecm``.
...
def dmac_ardl(
    *,
    ...
    """Node ``dmac_ardl`` -- METHOD-SELECTION card #26.

    dynardl ARDL/ECM + stochastic simulation + PSS bounds + residual diagnostics.
    ...
    raise NotImplementedError(
        "dmac_ardl: not implemented. The method card is in ./README.md."
    )
...
def dmac_pssbounds(
    *,
    ...
    """Node ``dmac_pssbounds`` -- METHOD-SELECTION card #26.
    ...
    Args:
        object: [raw_handle, required] Handle to a 'dynardl' estimated with ec=True (from
            dmac_ardl).
    ...
    """
    raise NotImplementedError(
        "dmac_pssbounds: not implemented. The method card is in ./README.md."
    )
...
def dmac_autocorr(
    *,
    ...
    """Node ``dmac_autocorr`` -- METHOD-SELECTION card #26.
    ...
    Args:
        object: [raw_handle, required] Handle to a 'dynardl' model (from dmac_ardl).
    ...
    """
    raise NotImplementedError(
        "dmac_autocorr: not implemented. The method card is in ./README.md."
    )
