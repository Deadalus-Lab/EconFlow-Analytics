...
"""Method wrapper ``univariate_garch_family_2`` -- METHOD-SELECTION card #154.

#154 Univariate GARCH family (vanilla/egarch/gjr/aparch/component)

Category 06-volatility-regimes; module ``univariate_garch_family_2``.
...
def tg_estimate(
    *,
    ...
    """Node ``tg_estimate`` -- METHOD-SELECTION card #154.
    ...
    raise NotImplementedError(
        "tg_estimate: not implemented. The method card is in ./README.md."
    )
...
def tg_predict(
    *,
    ...
    """Node ``tg_predict`` -- METHOD-SELECTION card #154.
    ...
    """
    raise NotImplementedError(
        "tg_predict: not implemented. The method card is in ./README.md."
    )
...
def tg_backtest(
    *,
    ...
    """Node ``tg_backtest`` -- METHOD-SELECTION card #154.
    ...
    """
    raise NotImplementedError(
        "tg_backtest: not implemented. The method card is in ./README.md."
    )
