...
"""Method wrapper ``nnfor`` -- METHOD-SELECTION card #133.

#133 nnfor (neural-network univariate forecasting: MLP ensemble + ELM)

Category 02-univariate-forecasting; module ``nnfor``.
...
def nnf_mlp(
    *,
    ...
    """Node ``nnf_mlp`` -- METHOD-SELECTION card #133.

    nnfor (neural-network univariate forecasting: MLP ensemble + ELM).
    ...
    Args:
        ...
        seed: [integer, required] REQUIRED seed (set.seed before the random weights; cache key;
    ...
    raise NotImplementedError(
        "nnf_mlp: not implemented. The method card is in ./README.md."
    )
...
def nnf_elm(
    *,
    ...
    """Node ``nnf_elm`` -- METHOD-SELECTION card #133.
    ...
    Args:
        ...
        seed: [integer, required] REQUIRED seed (set.seed before the random hidden weights; cache
            key).
        h: [integer, optional] Forecast horizon (positive integer; None -> frequency(y)).
    ...
    """
    raise NotImplementedError(
        "nnf_elm: not implemented. The method card is in ./README.md."
    )
